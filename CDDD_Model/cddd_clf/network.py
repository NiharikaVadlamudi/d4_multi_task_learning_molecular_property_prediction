...
- A simple classification network  with CDDD Descriptors + Task FC Layers 
...
class CDDD_FC(nn.Module):
    def __init__(self,ntasks=4,input_dim = 512 , intermediate_dim_1= 128 , intermediate_dim_2 = 32 ,  intermediate_dim_3=8) : 
